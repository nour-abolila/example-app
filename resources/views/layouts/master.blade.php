{{-- this is the master code of my project --}}
...
<head>
	...
	<title>Fruitkha - Slider Version</title>
                         ...
                         {{-- we use {{asset}} to make the pages show--}}
	<!-- favicon -->
    ...
    {{-- this is code to make the code good --}}
	<style>  
	.subtitle {
	letter-spacing: 0px !important;
	}
	</style>
    {{-- this is code to make the code good (end) --}}
</head>
<body>
   ...
   {{-- this to connect with other pages  --}}
